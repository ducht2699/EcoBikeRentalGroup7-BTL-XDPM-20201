    ...
    private void getTransaction() throws SQLException {
        ...
        while (rs.next()) {
            ...
            while (rs2.next()) {
                ...
                bike.setManufacturingDate(rs2.getString("manuafacturing_date"));
                bike.setProducer(rs2.getString("producer"));
                bike.setBateryPercentage(rs2.getString("batery_percentage"));
                bike.setLoadCycles(rs2.getString("load_cycles"));
