...
public class RentBikeScreen extends javax.swing.JFrame {
     ...
     */
    public RentBikeScreen(User user, Bike bike, JFrame backScreen) {
        initComponents();
    ...
    public void showInfoTable() {
        ...
        Cost cost = new Cost();
        String sqlGetStation = "SELECT * FROM stations WHERE stations.id = " + bike.getStationId();
        String sqlGetPrice = "SELECT * FROM cost WHERE bike_type = '" + bike.getType() + "'";
        try {
            ResultSet rs = db.query(sqlGetStation);
            rs.next();
            station.setName(rs.getString("name"));

            rs = db.query(sqlGetPrice);
            rs.next();
            cost.setDeposit(rs.getFloat("deposit"));
            bike.setCost(cost);
        ...
        model.setValueAt(cost.getDeposit(), 12, 1);
    ...
    private void requestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestButtonActionPerformed
        System.out.print(bike.getStatus());
        if (bike.getStatus() == 0) {
            PaymentScreen pm;
            try {
            ...
            JOptionPane.showMessageDialog(this, "Bike's busy. Choose another bike!");
        }
