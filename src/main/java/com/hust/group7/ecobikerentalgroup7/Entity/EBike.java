...
public class EBike extends Bike{
	...
	public EBike(int bikeId, String name, String type, float weight, String licensePlate, String manufacturingDate,
			String producer, String barcode, int status, int stationId, String image, Cost cost) {
		super(bikeId, name, type, weight, licensePlate, manufacturingDate, producer, barcode, status, stationId, image, cost);
		// TODO Auto-generated constructor stub
	}

	public EBike(int bikeId, String name, String type, float weight, String licensePlate, String manufacturingDate,
			String producer, String barcode, int status, int stationId, String image, Cost cost, String bateryPercentage, String loadCycles, String timeRemaining) {
		super(bikeId, name, type, weight, licensePlate, manufacturingDate, producer, barcode, status, stationId, image, cost);
